...
@test
  ...
  When  Click on the question "Why QA?"
  And  Answer should be "Now, I don’t believe that there is only one good answer for this question, yet through the infinite"